...
abstract class ReviewTemplateItem(
    @Id @Tsid
    var id: Long? = null,
    ...
    @JoinColumn(name = "review_template_section_id", nullable = false)
    var section: ReviewTemplateSection? = null,
) : BaseEntity(), SortOrderable<ReviewTemplateItem>
